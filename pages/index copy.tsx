...
export default function Home() {
  ...
  //   const img = pokemonscol.map( poke => poke.sprites.other.home.front_default )

  //   ////////////////////////////
  //   const pokeGenders = pokemonsByGenderDos.map( poke => poke.name )
  ...
  // const finalPokeArray = () => {

  //   const img = newArrayPokes.map( poke => poke.img )
  //   const id = newArrayPokes.map( poke => poke.id )
  //   const name = newArrayPokes.map( poke => poke.name )

  //   const color = pokemonsByColor.map( poke => poke.name )
  //   const gender = pokemonsByGenderDos.map( poke => poke.name )

  //   ////////////////////////////
  //   let pokemonsFilteredFinal = newArrayPokes.map((name, index_value) => {
  //       return {
  //         name: name.name,
  //         id:   id[index_value],
  //         img:  img[index_value],
  //       };
  //   });
  //   setPokes(pokemonsFilteredFinal);
  ...
  //   }
  //   console.log(paginate(pokes, 5, 1));
  // }
